...
Constituencies <- readShapePoly('Shapefiles/Constituency/constituencies.shp')
...
title(main = 'Constituencies')
```
### Criteria to identify a district in step 1
...
We first want to see where are the different units that have been identified